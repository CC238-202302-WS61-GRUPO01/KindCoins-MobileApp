...
//solo esta funcionando con el path de la imagen si esta online y no con todas, en si era para la api, ver correcion
...
class HomeScreen extends StatelessWidget {
  final List<Map<String, String>> explorarItems = [
    ...
    {
      'imageURL': 'kindcoins\\windows\\runner\\resources\\card-2.jpg',
      'title': 'Título 2',
      'description':
          'Las comidas compartidas proporcionarán a las familias de Palestina un apoyo en efectivo para que puedan comprar alimentos en tiendas locales.',
    },
    {
      'imageURL': 'kindcoins\\windows\\runner\\resources\\card-1.jpg',
      'title': 'Título 3',
      'description':
          'Las comidas compartidas proporcionarán a las familias de Palestina un apoyo en efectivo para que puedan comprar alimentos en tiendas locales.',
    }
